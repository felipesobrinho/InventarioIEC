...
import { User, UserMinus, UserPlus, Loader2, Check } from 'lucide-react'
          ...
          >
              ...
              <div className="flex items-center gap-2 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  {entidade === 'ramais' && aloc.whatsapp === true && (
                    <span className="inline-flex items-center gap-1 text-[11px] font-medium px-2 py-0.5 rounded-full mt-1 bg-green-200 dark:bg-green-900 text-green-800 dark:text-green-200">
            ...
            {entidade === 'ramais' && editandoWhatsappId === aloc.id ? (
              ...
              <button
                ...
                className="mt-2 text-xs text-blue-500 hover:text-blue-700 dark:hover:text-blue-400 transition"
              >
                Editar
              </button>
            ) : null}
